...
import com.nhs.controller.AppointmentController;
...
public class AppointmentPanel extends JPanel {
    ...
    public AppointmentPanel() {
        ...
        new AppointmentController(this);
    }
    ...
    private void createTablePanel() {
        ...
        appointmentTable.getTableHeader().setBackground(new Color(0, 94, 184));
    ...
    private void createButtonPanel() {
        ...
        addButton = createButton("Add Appointment", "add_icon.png", new Color(76, 175, 80));
        editButton = createButton("Edit Appointment", "edit_icon.png", new Color(33, 150, 243));
        deleteButton = createButton("Delete Appointment", "delete_icon.png", new Color(244, 67, 54));
